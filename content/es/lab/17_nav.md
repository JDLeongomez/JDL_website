...
<nav class="lab-nav-links" aria-label="Navegación del laboratorio">
  <a href="#20_people_current" class="lab-nav-btn">Equipo actual</a>
  <a href="#25_people_alumni" class="lab-nav-btn">Antiguos miembros</a>
</nav>
