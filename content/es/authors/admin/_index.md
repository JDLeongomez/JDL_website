...
Soy Profesor Asociado e investigador de [***EvoCo**: Laboratorio de Evolución y Comportamiento Humano*](/es/team/), de la [Facultad de Psicología](https://www.unbosque.edu.co/psicologia) de la [Universidad El Bosque](https://www.unbosque.edu.co/) en Bogotá, Colombia, y lider del grupo de investigación [***CODEC**: Ciencias Cognitivas y del Comportamiento*](https://investigaciones.unbosque.edu.co/codec) (clasificado como [**A1**](https://scienti.minciencias.gov.co/gruplac/jsp/visualiza/visualizagr.jsp?nro=00000000001446)). También soy fundador y miembro del Consejo Directivo de ***Latin American Association for Human Behavioral and Evolutionary Sciences*** (***LAAHBES***), y me desempeño como [recomendador](https://rr.peercommunityin.org/about/recommenders) (equivalente a Editor Asociado) para [***Peer Community In Registered Reports***](https://rr.peercommunityin.org/).
