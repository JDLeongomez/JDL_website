...
Soy Profesor Titular e investigador de [***EvoCo**: Laboratorio de Evolución y Comportamiento Humano*](/es/team/), de la [Facultad de Psicología](https://www.unbosque.edu.co/psicologia) de la [Universidad El Bosque](https://www.unbosque.edu.co/) en Bogotá, Colombia, y lidero el grupo de investigación [***CODEC**: Ciencias Cognitivas y del Comportamiento*](https://grupo-codec.netlify.app) (clasificado como [**A1**](https://scienti.minciencias.gov.co/gruplac/jsp/visualiza/visualizagr.jsp?nro=00000000001446)). 

También soy fundador y miembro del Consejo Directivo de ***Latin American Association for Human Behavioral and Evolutionary Sciences*** (***LAAHBES***), y me desempeño como [Data Editor](https://royalsocietypublishing.org/rspb/pages/Editorial_Board) para [***Proceedings of the Royal Society B***](https://royalsocietypublishing.org/rspb), como [recomendador](https://rr.peercommunityin.org/about/recommenders) (equivalente a Editor Asociado) para [***PCI Registered Reports***](https://rr.peercommunityin.org/), y como [Editor Asociado](https://evohuman.org/edhb/editorial-board) para [***Evolutionary Dynamics of Human Behavior (EDHB)***](https://evohuman.org/edhb/index).
...
Soy también un apasionado por los métodos cuantitativos y la programación en [<i class="fab fa-r-project"></i>](https://www.r-project.org/about.html)&nbsp;(usando [RStudio](https://rstudio.com/products/rstudio/)), y abogo por la reproducibilidad y la ciencia abierta. En este espíritu, impulsé la creación de [Meta<strong>Ciencia</strong>](/es/metaciencia/), un semillero académico orientado a explorar críticamente cómo se hace ciencia y a formar estudiantes y profesores/as en prácticas abiertas, colaborativas y reproducibles.  
